...
import { mockPatientIntake, mockReports, rawOcrLipidFixture, rawOcrCbcFixture } from '../lib/mock-data';
import {
  detectAllConflicts,
  detectAllergyMedicationConflicts,
  detectCriticalLabAlerts,
  detectMissingReferenceRanges,
} from '../lib/conflict-detector';
import { generateClinicalSummaries } from '../lib/summarizer';
...
const testLabsWithCritical: ExtractedLabResult[] = [
  ...allMockLabs,
  {
    id: 'crit-trop-test',
    reportId: 'rep-test',
